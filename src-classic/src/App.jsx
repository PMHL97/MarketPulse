        ...
        <div className="fixed top-4 right-4 z-50">
          <div className="flex items-center rounded-full border border-gray-300 bg-gray-100 overflow-hidden shadow-sm">
            <button
              ...
              className="px-3 py-1.5 text-xs sm:text-sm font-medium text-gray-800 bg-white hover:bg-gray-50 border-r border-gray-300 h-8"
            ...
            <button
              ...
              className="px-3 py-1.5 text-xs sm:text-sm font-medium text-green-700 hover:text-green-800 h-8"
              aria-label="AI Mode"
            >
              AI
            </button>
